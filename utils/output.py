...
def save_spreadsheet(path: str, results: list[RESULTS_TYPE]) -> None:
    ...
    with open(path, "w", encoding="utf-8") as f:
        ...
        writer.writeheader()
        writer.writerows(
            [{col: study.get(col, None) for col in COLUMN_NAMES} for study in results]
        )
...
def plot_data_time(
    ...
    if not no_lines and extra_info is not None:
        ...
        r_sq = r_values**2.0
        line_labels = [
            f"O$_2$ Pulse$ = {slopes[0]:.2f}t + {intercepts[0]:.2f}, " +
            f"R^2 = {r_sq[0]:.4f}$",
            f"O$_2$ Pulse$ = {slopes[1]:.2f}t + {intercepts[1]:.2f}, " +
            f"R^2 = {r_sq[1]:.4f}$",
        ]
        l0 = ax[2].plot(
    ...
    if no_transition_annotations and no_auc and no_lines:  # nothing
        ...
        ax[2].legend(
            handles=[*line_handles, auc_handle],
            labels=[*line_labels, auc_label],
            loc="upper center",
            bbox_to_anchor=(0.5, -0.5),
            fancybox=False,
            shadow=False,
        ...
        ax[2].legend(
            handles=[*ann_handles, auc_handle],
            labels=[*ann_labels, auc_label],
            loc="upper center",
            bbox_to_anchor=(0.5, -0.5),
            fancybox=False,
            shadow=False,
        ...
        ax[2].legend(
            handles=[*ann_handles, *line_handles],
            labels=[*ann_labels, *line_labels],
            loc="upper center",
            bbox_to_anchor=(0.5, -0.5),
            fancybox=False,
            shadow=False,
...
def plot_data_nondimensional(
    ...
    if not no_lines and extra_info is not None:
        ...
        tau = r"\tau"
        line_labels = [
            f"O$_2$ Pulse$ = {slopes[0]:.2f}{tau} + {intercepts[0]:.2f}, " +
            f"R^2 = {r_sq[0]:.4f}$",
            f"O$_2$ Pulse$ = {slopes[1]:.2f}{tau} + {intercepts[1]:.2f}, " +
            f"R^2 = {r_sq[1]:.4f}$",
        ]
        l0 = ax[2].plot(
            [start_time, trans_time],
